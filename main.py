...
# KONFIGURIMI KRYESOR - ME TOKENIN E RI
...
def send_welcome(message):
    # Fshijmë butonat e vjetër të tastierës që mund të jenë mbetur
...
def final_step(call):
    ...
    if post_content:
        try:
            ...
            # Konfirmim te Admini
            bot.send_message(ADMIN_ID, f"✅ @{call.from_user.username} hat gepostet in {kanton}.")
...
# Ndezja e botit (skip_pending=True injoron mesazhet e vjetra që shkaktojnë 409)
print("Boti po punon...")
